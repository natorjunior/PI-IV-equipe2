document.addEventListener('DOMContentLoaded', async () => {
    ...
    async function carregarProdutos() {
        try {
            ...
            const response = await fetch('/api/suplementos/search'); 
            ...
            produtos.forEach(prod => {
                ...
                tr.innerHTML = `
                    ...
                    <td><span class="status-${prod.status_aprovacao.toLowerCase()}">${prod.status_aprovacao}</span></td>
                    <td>
                        <button class="action-btn btn-edit" onclick="editarProduto(${prod.id_suplemento})">
                            <i class="fa-solid fa-pen"></i>
                        </button>
                        <button class="action-btn btn-delete" onclick="deletarProduto(${prod.id_suplemento})">
...
async function editarProduto(id) {
    ...
    try {
        ...
        if(prod.data_laudo) {
            ...
            document.getElementById('prod-data').value = date.toISOString().split('T')[0];
        }
